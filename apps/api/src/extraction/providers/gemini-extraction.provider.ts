...
export class GeminiExtractionProvider implements ExtractionProvider {
  ...
  private buildPrompt(ocrText: string, locale?: string): string {
    ...
    return [
      'Egy fuvarozó cég szervizszámláját dolgozod fel. A bemenet egy számla OCR',
      'szövege (magyar, román vagy angol nyelven). Adj vissza KIZÁRÓLAG egy JSON',
      'objektumot az alábbi szerződés szerint, magyarázat nélkül.',
      '',
      'JSON szerződés:',
      '{',
      '  "invoice": {',
