  ...
  implements VehicleExtractionProvider
{
  ...
  private buildPrompt(ocrText: string, locale?: string): string {
    return [
      ...
      '- A category (J) a pontos EU-kód legyen: tehergépjármű N1/N2/N3, pótkocsi/',
      '  félpótkocsi O1–O4. Pótkocsinál a vehicleType (D.2) jelezze, ha FÉLpótkocsi',
      '  (nyerges – semiremorcă / Sattelanhänger / semi-trailer) vagy sima pótkocsi',
      '  (remorcă / Anhänger / trailer).',
