...
export class StubOcrProvider implements OcrProvider {
  recognize(input: OcrInput): Promise<OcrResult> {
    const text = [
      ...
      '',
      'Tételek:',
      '1. Fékbetét csere (első) - 2 db - 18.000 Ft',
      '2. Olajcsere 5W30 motorolaj - 4 liter - 12.000 Ft',
      '3. Olajszűrő - 1 db - 3.500 Ft',
      '4. Munkadíj - 15.000 Ft',
      '',
      'Nettó összesen: 48.500 Ft',
      'ÁFA (27%): 13.095 Ft',
      'Bruttó összesen: 61.595 Ft',
    ].join('\n');
